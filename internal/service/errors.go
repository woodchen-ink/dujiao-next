...
var (
	...
	ErrCZLConnectDisabled                  = errors.New("czl connect disabled")
	ErrCZLConnectStateInvalid              = errors.New("czl connect state invalid")
	ErrCZLConnectTokenFailed               = errors.New("czl connect token failed")
	ErrCZLConnectTokenInvalid              = errors.New("czl connect token invalid")
	ErrCZLConnectUserInfoFailed            = errors.New("czl connect userinfo failed")
	ErrCZLConnectEmailMissing              = errors.New("czl connect email missing")
)
